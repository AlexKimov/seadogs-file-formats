...
| №   | Название | Описание | 
| :-- | :-------- | :------ |
| 1 | [DecodeDAT.1sc](https://github.com/AlexKimov/seadogs-file-formats/blob/master/scripts/DecodeDAT.1sc)  | Скрипт для шифровки/расшифровки **.dat** файлов игры Век Парсуников 2 |
...
| 5 | [EncodeActionFile.1sc](https://github.com/AlexKimov/seadogs-file-formats/blob/master/scripts/EncodeActionFile.1sc)  | Скрипт для шифровки **.a** файлов игры Корсары ПДМ |
