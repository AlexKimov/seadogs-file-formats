...
Разбор форматов файлов игр **Корсары Проклятье дальних морей** (2000) , **Век парусников 2** (2001) и **Рыцари Морей** (2002). 
...
| :-- | :-------- | :------ | :------ |
| 1 | Корсары Проклятье Дальних морей / Sea Dogs  | 2000   | .ani, .cff, .clf, .sc, .tf, .def, .idf |
| 2 | Век парусников 2  | 2001  | .cmp, .tf, .pak  |
| 3 | Рыцари Морей  | 2002  | .cmp, .tf, .pak   |
